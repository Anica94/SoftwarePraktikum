...
public class TestBuild extends TestCase{
	...
	public void test() {
		...
		build = new Build();
		try {
			reader.read("C:\\Users\\Sonja\\eclipse-workspace\\SoftwarePraktikum\\src\\Textfiles\\Test\\BinconsistentBig.txt");
		} catch (IOException e1) {
			// is tested at TestReaderBUILD
		}
		leaves = reader.getLeafset();
         ...
         *  produce expected tree
         */
        expectedTree = new UndirectedGraph();
        expectedTree.addVertex(new Integer(1));
        expectedTree.addVertex(new Integer(2));
        expectedTree.addVertex(new Integer(3));
        expectedTree.addVertex(new Integer(4));
        ...
        changes = build.getChanges();
		success = changes.size()==expectedChanges.size();
		System.out.println("ch= "+ changes.size());
		System.out.println("ex= "+ expectedChanges.size());
		...
		/*
		 * test consistent tripleset caterpillar
		 */
		build = new Build();
		try {
			reader.read("C:\\Users\\Sonja\\eclipse-workspace\\SoftwarePraktikum\\src\\Textfiles\\Test\\BCaterpillar.txt");
		} catch (IOException e1) {
			// is tested at TestReaderBUILD
		}
		leaves = reader.getLeafset();
        ...
        expectedTree.addVertex(new Integer(5));
        expectedTree.addVertex(new Integer(6));
        expectedTree.addVertex(new Integer(7));
        expectedTree.addVertex(new Integer(8));
        expectedTree.addVertex(new Integer(29));
        expectedTree.addVertex(new Integer(30));
        expectedTree.addVertex(new Integer(31));
        expectedTree.addVertex(new Integer(32));
        expectedTree.addVertex(new Integer(33));
        expectedTree.addVertex(new Integer(34));
        expectedTree.addVertex(new Integer(35));
		expectedTree.addEdge(new Integer(1), new Integer(29));
		expectedTree.addEdge(new Integer(2), new Integer(29));
		expectedTree.addEdge(new Integer(30), new Integer(29));
		expectedTree.addEdge(new Integer(3), new Integer(30));
		expectedTree.addEdge(new Integer(31), new Integer(30));
		expectedTree.addEdge(new Integer(4), new Integer(31));
		expectedTree.addEdge(new Integer(31), new Integer(32));
		expectedTree.addEdge(new Integer(5), new Integer(32));
		expectedTree.addEdge(new Integer(32), new Integer(33));
		expectedTree.addEdge(new Integer(6), new Integer(33));
		expectedTree.addEdge(new Integer(33), new Integer(34));
		expectedTree.addEdge(new Integer(7), new Integer(34));
		expectedTree.addEdge(new Integer(34), new Integer(35));
		expectedTree.addEdge(new Integer(8), new Integer(35));
		/*
		 * 	check vertices
		 */
		vertices = tree.getVertices();
        ...
        expectedChanges.add(new VertexOperation("aho add", new Integer(3)));
        expectedChanges.add(new VertexOperation("aho add", new Integer(4)));
        expectedChanges.add(new VertexOperation("aho add", new Integer(5)));
        expectedChanges.add(new VertexOperation("aho add", new Integer(6)));
        expectedChanges.add(new VertexOperation("aho add", new Integer(7)));
        expectedChanges.add(new VertexOperation("aho add", new Integer(8)));
        expectedChanges.add(new EdgeOperation("aho add", new Integer(1), new Integer(2)));
		expectedChanges.add(new EdgeOperation("aho add", new Integer(2), new Integer(3)));
		expectedChanges.add(new EdgeOperation("aho add", new Integer(3), new Integer(4)));
		expectedChanges.add(new EdgeOperation("aho add", new Integer(4), new Integer(5)));
		expectedChanges.add(new EdgeOperation("aho add", new Integer(5), new Integer(6)));
		expectedChanges.add(new EdgeOperation("aho add", new Integer(6), new Integer(7)));
		// connected components
		expectedChanges.add(new VertexOperation("consider", new Integer(1)));
		expectedChanges.add(new VertexOperation("choose", new Integer(1)));
		expectedChanges.add(new VertexOperation("consider", new Integer(2)));
		...
		expectedChanges.add(new VertexOperation("consider", new Integer(4)));
		expectedChanges.add(new VertexOperation("choose", new Integer(4)));
		expectedChanges.add(new VertexOperation("consider", new Integer(5)));
		expectedChanges.add(new VertexOperation("choose", new Integer(5)));
		expectedChanges.add(new VertexOperation("consider", new Integer(6)));
		expectedChanges.add(new VertexOperation("choose", new Integer(6)));
		expectedChanges.add(new VertexOperation("consider", new Integer(7)));
		expectedChanges.add(new VertexOperation("choose", new Integer(7)));
		expectedChanges.add(new VertexOperation("consider", new Integer(8)));
		expectedChanges.add(new VertexOperation("choose", new Integer(8)));
			// recursive call 1
			// aho graph
			expectedChanges.add(new VertexOperation("aho add", new Integer(1)));
	        expectedChanges.add(new VertexOperation("aho add", new Integer(2)));
			...
			expectedChanges.add(new VertexOperation("choose", new Integer(7)));
				...
				expectedChanges.add(new VertexOperation("choose", new Integer(6)));
					...
					expectedChanges.add(new VertexOperation("choose", new Integer(5)));
						...
						expectedChanges.add(new VertexOperation("choose", new Integer(4)));
							...
							expectedChanges.add(new VertexOperation("choose", new Integer(3)));
								...
								expectedChanges.add(new VertexOperation("choose", new Integer(2)));
									...
									expectedChanges.add(new VertexOperation("build add", new Integer(2)));
								// build
								expectedChanges.add(new VertexOperation("build add", new Integer(29)));
								expectedChanges.add(new EdgeOperation("build add", new Integer(29), new Integer(1)));
								expectedChanges.add(new EdgeOperation("build add", new Integer(29), new Integer(2)));
								// recursive call 1.1.1.1.1.2
								// aho graph
								expectedChanges.add(new VertexOperation("aho add", new Integer(3)));
								// connected components
								expectedChanges.add(new VertexOperation("consider", new Integer(3)));
								...
								expectedChanges.add(new VertexOperation("build add", new Integer(3)));
							// build
							expectedChanges.add(new VertexOperation("build add", new Integer(30)));
							expectedChanges.add(new EdgeOperation("build add", new Integer(30), new Integer(29)));
							expectedChanges.add(new EdgeOperation("build add", new Integer(30), new Integer(3)));
							// recursive call 1.1.1.1.2
							// aho graph
							expectedChanges.add(new VertexOperation("aho add", new Integer(4)));
							// connected components
							expectedChanges.add(new VertexOperation("consider", new Integer(4)));
							...
							expectedChanges.add(new VertexOperation("build add", new Integer(4)));
						// build
						expectedChanges.add(new VertexOperation("build add", new Integer(31)));
						expectedChanges.add(new EdgeOperation("build add", new Integer(31), new Integer(30)));
						expectedChanges.add(new EdgeOperation("build add", new Integer(31), new Integer(4)));
						// recursive call 1.1.1.2
						// aho graph
						expectedChanges.add(new VertexOperation("aho add", new Integer(5)));
						// connected components
						expectedChanges.add(new VertexOperation("consider", new Integer(5)));
						...
						expectedChanges.add(new VertexOperation("build add", new Integer(5)));
					// build
					expectedChanges.add(new VertexOperation("build add", new Integer(32)));
					expectedChanges.add(new EdgeOperation("build add", new Integer(32), new Integer(31)));
					expectedChanges.add(new EdgeOperation("build add", new Integer(32), new Integer(5)));
					...
					expectedChanges.add(new VertexOperation("build add", new Integer(6)));
				// build
				expectedChanges.add(new VertexOperation("build add", new Integer(33)));
				expectedChanges.add(new EdgeOperation("build add", new Integer(33), new Integer(32)));
				expectedChanges.add(new EdgeOperation("build add", new Integer(33), new Integer(6)));
				// recursive call 1.2
				// aho graph
				expectedChanges.add(new VertexOperation("aho add", new Integer(7)));
				// connected components
				...
				expectedChanges.add(new VertexOperation("choose", new Integer(7)));
				// build
				expectedChanges.add(new VertexOperation("build add", new Integer(7)));
			// build
			expectedChanges.add(new VertexOperation("build add", new Integer(34)));
			expectedChanges.add(new EdgeOperation("build add", new Integer(34), new Integer(33)));
			expectedChanges.add(new EdgeOperation("build add", new Integer(34), new Integer(7)));
		// recursive call 2
		// aho graph
		expectedChanges.add(new VertexOperation("aho add", new Integer(8)));
		// connected components
		...
		expectedChanges.add(new VertexOperation("choose", new Integer(8)));
		//build
		expectedChanges.add(new VertexOperation("build add", new Integer(8)));
		expectedChanges.add(new VertexOperation("build add", new Integer(35)));
		expectedChanges.add(new EdgeOperation("build add", new Integer(35), new Integer(34)));
		expectedChanges.add(new EdgeOperation("build add", new Integer(35), new Integer(8)));
		/*
         * 	check changes
         */
        changes = build.getChanges();
		...
		/*
		 * test consistent tripleset binary 20 leaves
		 *  short test because of big range
		 *  only for testing visualization
		 */
		build = new Build();
		try {
			reader.read("C:\\Users\\Sonja\\eclipse-workspace\\SoftwarePraktikum\\src\\Textfiles\\Test\\B20VerticesBinary.txt");
		} catch (IOException e1) {
			// is tested at TestReaderBUILD
		}
		leaves = reader.getLeafset();
        ...
        tree = rootedTree.getFirst();
        root = rootedTree.getSecond();
        assertNotNull("build.build(triples, leaves, new Integer(-1)) did return null as root for a consistent tripleset.", root);
        assertNotNull("build.build(triples, leaves, new Integer(-1)) did return null as tree for a consistent tripleset.", tree);
	}
}
