...
public interface Graph {
	 ...
	 */
	boolean addVertex(long vertexName);
	 ...
	 * @throws NullPointerException if the specified name is <code> null</code>.
	 */
	boolean containsVertex(long vertexName);
	 ...
	 * @throws NullPointerException if the specified name is <code> null</code>.
	 */
	boolean deleteVertex(long vertexName);
	 ...
	 * If they are not found in graph IllegalArgumentException is thrown.</p>
	 * 
     ...
     * null</code>.
	 */
	boolean isAdjacentTo(long vertexNameStart, long vertexNameEnd);
     ...
     * null</code>.
	 */
	boolean addEdge(long vertexNameStart, long vertexNameEnd);
     ...
     * null</code>.
	 */
	boolean addEdge(long vertexNameStart, long vertexNameEnd, int edgeWeight);
	 ...
	 */
	boolean containsEdge(long vertexNameStart, long vertexNameEnd);
	 ...
	 * @throws NullPointerException if any of the specified vertices is <code> null</code>.
	 */
	boolean deleteEdge(long vertexNameStart, long vertexNameEnd);
	 ...
	 * @throws NullPointerException if any of the specified vertices is <code> null</code>.
	 */
	int getEdgeWeight(long vertexNameStart, long vertexNameEnd);
	 ...
	 */
	void setEdgeWeight(long vertexNameStart, long vertexNameEnd, int newEdgeWeight);
